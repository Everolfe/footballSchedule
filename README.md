# Анализ архитектуры микросервисного маркетплейса
...
Проект использует **контейнеризированное развертывание** с акцентом на изоляцию сервисов и простоту локального запуска..
