...
В рамках проекта разрабатывалась бэкенд-часть для REST API сервиса просмотра футбольных матчей. Приложение работает с четырьмя основными моделями данных:
