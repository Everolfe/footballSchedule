...
public final class ArenaConstants {
    ...
    public static final String GET_ALL_DESCRIPTION =
            "Retrieves all arenas with their matches information";
    public static final String GET_BY_CAPACITY_DESCRIPTION =
            "Finds arenas within specified capacity range";
    public static final String GET_BY_ID_DESCRIPTION =
            "Retrieves a specific arena by its identifier";
    public static final String UPDATE_DESCRIPTION =
            "Updates an existing arena's information";
    public static final String DELETE_DESCRIPTION =
            "Removes an arena from the system";
    public static final String BULK_CREATE_DESCRIPTION =
            "Creates multiple arenas in a single operation";
    ...
    public static final String MIN_CAPACITY_DESCRIPTION =
            "Minimum capacity of arenas to search for";
    public static final String MAX_CAPACITY_DESCRIPTION =
            "Maximum capacity of arenas to search for";
