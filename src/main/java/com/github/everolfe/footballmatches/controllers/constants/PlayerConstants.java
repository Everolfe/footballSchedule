...
public final class PlayerConstants {
    ...
    public static final String TAG_DESCRIPTION =
            "Provides operations for managing football players";
    ...
    public static final String GET_ALL_DESCRIPTION =
            "Retrieves all players with their team information";
    public static final String GET_BY_ID_DESCRIPTION =
            "Retrieves a specific player by their identifier";
    ...
    public static final String BULK_CREATE_DESCRIPTION =
            "Creates multiple players in a single operation";
