...
class MatchServiceTest {
    ...
    void testCreateMatch() {
        ...
        assertThrows(BadRequestException.class, () -> matchService.create(null));
    }
    ...
    @Test
    void testReadById() {
        when(cache.get(CacheConstants.getMatchCacheKey(1))).thenReturn(testMatchDto);
        ...
        when(cache.get(CacheConstants.getMatchCacheKey(1))).thenReturn(null);
        ...
        assertThrows(ResourcesNotFoundException.class, () -> matchService.read(1));
    }
    ...
    void testUpdateMatch() {
        ...
        when(matchRepository.findById(1)).thenReturn(Optional.empty());
        assertThrows(ResourcesNotFoundException.class, () -> matchService.update(testMatch, 1));
    }
    ...
    void testDeleteMatch() {
        ...
        when(matchRepository.findById(1)).thenReturn(Optional.empty());
        assertThrows(ResourcesNotFoundException.class, () -> matchService.delete(1));
    }
    ...
    void testAddTeamToMatch() {
        ...
        assertThrows(BadRequestException.class, () -> matchService.addTeamToMatch(1, 1));
    }
    ...
    void testRemoveTeamFromMatch() {
        ...
        assertThrows(BadRequestException.class, () -> matchService.removeTeamFromMatch(1, 3));
    }
    ...
    void testFindMatchesByDates() {
        ...
        when(matchRepository.findByDateTimeLessThanEqual(end)).thenReturn(List.of(testMatch));
        List<MatchDtoWithArenaAndTeams> result1 = matchService.findMatchesByDates(null, end);
        assertEquals(1, result1.size());
        assertEquals(testMatchDto, result1.get(0));

        when(matchRepository.findByDateTimeGreaterThanEqual(start)).thenReturn(List.of(testMatch));
        List<MatchDtoWithArenaAndTeams> result2 = matchService.findMatchesByDates(start, null);
        assertEquals(1, result2.size());
        assertEquals(testMatchDto, result2.get(0));

        when(matchRepository.findByDateTimeBetween(start, end)).thenReturn(List.of(testMatch));

        List<MatchDtoWithArenaAndTeams> result = matchService.findMatchesByDates(start, end);
